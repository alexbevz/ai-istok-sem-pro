...
from src.semantic_proximity.scheme import (EmbeddingScheme,
...
class SemanticProximityRouter(APIRouter):
    ...
    def __init__(self):
        ...
        self.add_api_route(endpoint=self.calculate_embedding, path="/embedding", methods=['POST'])
    ...
    async def add_items_from_file(cls,
                                  ...
                                  db: AsyncSession = Depends(get_session_db)) -> NumberOfCreatedItemsScheme:
    ...
    async def get_all_collection_items_by_collection_id(cls,
                                       ...
                                       user: User = Depends(get_current_user),
                                       db: AsyncSession = Depends(get_session_db)) -> GetAllCollectionElementsScheme:
    ...
    async def find_proxime_items(cls,
                                 ...
                                 user: User = Depends(get_current_user),
                                 db: AsyncSession = Depends(get_session_db)) -> ProximityResultScheme:
